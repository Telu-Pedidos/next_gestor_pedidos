...
const multiSelectVariants = cva(
  "flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium text-foreground py-2 ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-transparent text-title hover:bg-secondary/50 border border-secondary shadow-none",
        destructive:
                  ...
                  <div className="hidden flex-col gap-1 border-r border-foreground/10 pr-4 text-left md:flex">
                    {dateRanges.map(({ label, start, end }) => (
                      <Button
                        ...
                        size="sm"
                        className={cn(
                          "justify-start hover:bg-primary/90 hover:text-foreground",
                          selectedRange === label &&
                            "bg-primary text-foreground hover:bg-primary/90 hover:text-primary-foreground"
                        )}
                        onClick={() => {
